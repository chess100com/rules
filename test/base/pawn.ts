...
describe("Pawn", () => {
    ...
    it("takeover white", () => {
        let game = new Game()
        game.setFen("rnbcqksbnr/ppppppp1pp/10/10/6Pp2/10/10/10/PPPPPP1PPP/RNBCQKSBNR w KQkq h6 - 0 2")
        game.move(c("g6"), c("h7"))
        assert.equal(game.getFen(), "rnbcqksbnr/ppppppp1pp/10/7P2/10/10/10/10/PPPPPP1PPP/RNBCQKSBNR b KQkq - - 0 2")

        game.setFen("rnbcqksbnr/ppppppp1pp/10/6P3/7p2/10/10/10/PPPPPP1PPP/RNBCQKSBNR w KQkq h6 - 0 2")
        game.move(c("g7"), c("h8"))
    ...
    it("takeover black", () => {
        let game = new Game()
        game.setFen("rnbcqksbnr/ppppppp1pp/10/10/10/6Pp2/10/10/PPPPPP1PPP/RNBCQKSBNR b KQkq g5 - 0 2")
        game.move(c("h5"), c("g4"))
        assert.equal(game.getFen(), "rnbcqksbnr/ppppppp1pp/10/10/10/10/6p3/10/PPPPPP1PPP/RNBCQKSBNR w KQkq - - 0 3")

        game.setFen("rnbcqksbnr/ppppppp1pp/10/10/10/6P3/7p2/10/PPPPPP1PPP/RNBCQKSBNR b KQkq g5 - 0 2")
        game.move(c("h4"), c("g3"))
    ...
    it("pawn transformations", () => {
        ...
        let game = new Game()
        game.setFen("k9/9P/10/10/10/10/10/10/10/K9 w - - - 0 0")
        ...
        game.setFen("k9/10/10/10/10/10/10/10/9p/K9 b - - - 0 0")
    ...
    it("pawn transformations with eat", () => {
        ...
        let game = new Game()
        game.setFen("k7r1/9P/10/10/10/10/10/10/10/K9 w - - - 0 0")
        game.move(c("j9"), c("i10"), {pawnTransform: Figure.Queen})
        game.setFen("k7Q1/10/10/10/10/10/10/10/10/K9 b - - - 0 0")
        
        game.setFen("k9/10/10/10/10/10/10/10/9p/K7R1 b - - - 0 0")
        game.move(c("j2"), c("i1"), {pawnTransform: Figure.Queen})
        game.setFen("k9/10/10/10/10/10/10/10/10/K7q1 w - - - 0 1")        
